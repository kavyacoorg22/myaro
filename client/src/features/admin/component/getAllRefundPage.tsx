            ...
            <Table className="table-fixed w-full">
              <TableHeader>
                <TableRow className="border-b border-gray-100">
                  ...
                  <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-4 py-3 w-[90px]">Amount</TableHead>
                  <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-4 py-3 w-[110px]">Status</TableHead>
                  <TableHead className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-4 py-3 w-[130px]">Initiated By</TableHead>
