...
export class AdminUserManagementController{
  ...
  getAllUsers = async(req: Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    getAllBeautician = async(req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
   
            
            const page = Number(req.query.page) || 1;
            const limit = Number(req.query.limit) || 10;
            const verificationStatus = req.query.verificationStatus as VerificationStatusFilter;
...
getBeauticianProfile = async(req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
approveBeautician = async(req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
rejectBeautician = async(req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
       const userId = req.params.id;
        const adminId=req.user?.id||undefined
