...
export class SearchHistoryController{
  ...
  constructor(addSearchHistory:IAddSearchHistoryUseCase,recentSearch:IRecentSearchUseCase,
    removeSearchHistoryUC:IRemoveSearchHistoryUseCase,clearSearchHistoryUC:IClearSeachHistoryUseCase
  )
  {
  ...
  addSearchHistory=async(req:Request,res:Response,next:NextFunction):Promise<void>=>{
    try{
   ...
   recentSearch=async(req:Request,res:Response,next:NextFunction):Promise<void>=>{
    try{
     const userId=req.user?.id
   ...
   removeSearchHistory=async(req:Request,res:Response,next:NextFunction):Promise<void>=>{
    try{
   ...
   clearSearchHistory=async(req:Request,res:Response,next:NextFunction):Promise<void>=>{
    try{
     const userId=req.user?.id
