...
import { IRejectBeauticianUseCase } from "../../../interface/admin/management/IRejectBeauticianUseCase";
import { IResponse } from "../../../interfaceType/authtypes";

export class RejectBeauticianUseCase implements IRejectBeauticianUseCase {
