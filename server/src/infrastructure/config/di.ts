...
const createBookingUseCase=new CreateBookingUseCase(bookingRepo,chatRepository,getAvailabilityUC,lockSlotService,chatMessageService,notificationDispatchService,bookinghistoryService)
const updateBookingStatusUC=new UpdateBookingStatusUseCase(bookingRepo,bookingHistoryRepo,paymentrepo,notificationDispatchService,chatMessageService)
...
const requestRefundUseCase=new RequestRefundUseCase(bookingRepo,paymentrepo,socketEmitter,bookingValidatorService,bookinghistoryService,chatMessageService,paymentLookupService,notificationDispatchService)
const approveRefundRequestUseCase=new BeauticianApproveRefundUseCase(bookingRepo,paymentrepo,socketEmitter,bookingValidatorService,bookinghistoryService,paymentLookupService,chatMessageService,refundRepo,notificationDispatchService)
const disputeRefundUC=new DisputeRefundUseCase(bookingRepo,paymentrepo,bookingValidatorService,bookinghistoryService,paymentLookupService,chatMessageService,notificationDispatchService)
const cancelBookingUC=new CancelBookingUseCase(bookingValidatorService,paymentLookupService,bookinghistoryService,chatMessageService,socketEmitter,bookingRepo,paymentrepo,refundRepo,razorPayService,notificationDispatchService)
...
const verifyPaymentUC=new VerifyPaymentUsecase(paymentrepo,bookingRepo,razorPayService,blockBookedSlotUseCase,updateBookingStatusUC,scheduleNotificationUC)
