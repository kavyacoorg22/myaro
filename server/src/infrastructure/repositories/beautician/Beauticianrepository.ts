...
export class mongoBeauticianRepository
  extends GenericRepository<Beautician, BeauticianDoc>
  implements IBeauticianRepository
{
  constructor() {
  ...
  async updateVerificationByUserId(
    ...
    if (
      ...
      update.verifiedBy &&
      ObjectId.isValid(update.verifiedBy)
    ) {
