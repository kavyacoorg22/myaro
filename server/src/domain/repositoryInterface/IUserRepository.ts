...
export interface IUserRepository {
  create(
    dto: Omit<User, "id" | "createdAt" | "updatedAt" | "isVerified">,
  ): Promise<User>;
  ...
  getTotalBeauticians(): Promise<number>;
  getTotalCustomers(): Promise<number>;
  getUserGrowthByMonth(year?:number): Promise<UserGrowthDto[]>
}
